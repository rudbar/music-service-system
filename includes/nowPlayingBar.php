	...
	<div id="nowPlayingBar">
		...
		<div id="nowPlayingCenter">
			...
			<div class="content playerControls">
				...
				<div class="buttons">
					...
					<button class="controlButton shuffle" title="Кнопка перемешать музыку" onclick="setShuffle()">
						<img src="assets/images/icons/shuffle.png" alt="Перемешать">
					</button>

					<button class="controlButton previous" title="Кнопка предидущая песня" onclick="prevSong()">
		...
		<div id="nowPlayingRight">
			<div class="volumeBar">
				...
				<button class="controlButton volume" title="Кнопка уровня громкости" onclick="setMute()">
